...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="am-icon-trash text-danger"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="am-icon-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        zoomIcon: '<i class="am-icon-zoom-in"></i>',
        zoomClass: 'btn btn-xs btn-default',
        zoomTitle: 'View Details',
        dragIcon: '<i class="am-icon-menu-hamburger"></i>',
        dragClass: 'text-info',
        dragTitle: 'Move / Rearrange',
        dragSettings: {},
        indicatorNew: '<i class="am-icon-hand-down text-warning"></i>',
        indicatorSuccess: '<i class="am-icon-ok-sign text-success"></i>',
        indicatorError: '<i class="am-icon-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i class="am-icon-hand-up text-muted"></i>',
    ...
    tFileIcon = '<i class="am-icon-file kv-caption-icon"></i>';
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="am-icon-triangle-left"></i>',
            next: '<i class="am-icon-triangle-right"></i>',
            toggleheader: '<i class="am-icon-resize-vertical"></i>',
            fullscreen: '<i class="am-icon-fullscreen"></i>',
            borderless: '<i class="am-icon-resize-full"></i>',
            close: '<i class="am-icon-remove"></i>'
        },
        ...
        previewFileIcon: '<i class="am-icon-file"></i>',
        previewFileIconClass: 'file-other-icon',
        previewFileIconSettings: {},
        previewFileExtSettings: {},
        buttonLabelClass: 'hidden-xs',
        browseIcon: '<i class="am-icon-folder-open"></i>&nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="am-icon-trash"></i>',
        removeClass: 'btn btn-default',
        cancelIcon: '<i class="am-icon-ban-circle"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="am-icon-upload"></i>',
        ...
        msgValidationErrorIcon: '<i class="am-icon-exclamation-sign"></i> ',
